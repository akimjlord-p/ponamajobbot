...
7. Учитывай, что LIMIT больше {max_limit} недопустим.Лучше больше количество итераций, чем не полный ответ.
...
Нужно дать финальный ответ пользователю на основе уже собранных данных. Ответ должен быть обширный,
с доводами и пояснениями, предложениями.
